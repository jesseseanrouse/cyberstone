    ...
    return (
			<div className='infoPage'>
				...
				<div>
					...
					version of the game only has one boss but is beatable no matter how
					you build your character, it just might be easier or harder depending
					on your choices. There are currently no game overs for being defeated in combat so don't worry too much.
				</div>
				<h2>Stats</h2>
				<h4>Strength</h4>
				<div>
					This is a measure of how strong your character is and certain choices
					are affected by this. Also for each strength you have you get a boost
					in health.
				</div>
				<h4>Endurance</h4>
				<div>
				...
				<h4>Willpower</h4>
				<div>
					This is your character's tenacity and primary gets a
				...
				<h4>Energy</h4>
				<div>
					This is the amount of energy your character has and if it is depleted your character is defeated. In game this is referred to as ep (energy points).
				</div>
			</div>
		);
};
